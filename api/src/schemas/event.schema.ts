...
export const createEventSchema = z.object({
  ...
  visibility: z.enum(['PUBLIC', 'MEMBERS_ONLY', 'PRIVATE', 'ADMIN']).default('PUBLIC'),
...
export const queryEventsSchema = z.object({
  ...
  visibility: z.enum(['PUBLIC', 'MEMBERS_ONLY', 'PRIVATE', 'ADMIN']).optional(),
...
export const eventResponseSchema = z.object({
  ...
  location: z.string(),
  visibility: z.enum(['PUBLIC', 'MEMBERS_ONLY', 'PRIVATE', 'ADMIN']),
